        ...
        <div className="setup-sidebar">
          ...
          <div className="progress-section">
            ...
            <div className="progress-steps">
              ...
              <div className="step">
                ...
                <div className="step-content">
                  <div className="step-label">Validate Output</div>
                  <div className="step-sublabel">Review Generated Files</div>
                </div>
              </div>
              <div className="step-connector" />
              <div className="step">
                ...
                <div className="step-content">
                  ...
                  <div className="step-sublabel">Download and Create Pull Request</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="output-section">
            ...
            <div className="output-item">
              ...
              <span>Test Suite for Legacy Code (Python & COBOL)</span>
            </div>
            <div className="output-item">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                <circle cx="8" cy="8" r="6.5" />
        ...
        <div className="setup-form-panel">
          <form className="setup-form" onSubmit={handleSubmit}>
            ...
            <div className="form-section">
              ...
              <p className="section-subtitle">Connect your GitHub repository to sync legacy code.</p>
            ...
            <div className="form-section">
              <h2 className="section-title">3. Codebase Context</h2>
              <p className="section-subtitle">Describe what your existing codebase does.</p>

              <div className="textarea-wrapper">
                <textarea
                  id="context-input"
                  className="form-textarea"
                  placeholder="e.g., This is a codebase that generates image from text."
                  rows={5}
                  value={globalContext}
